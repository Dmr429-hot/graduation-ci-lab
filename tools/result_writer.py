...
SUC_FIELDS = ["package", "type"]

FAIL_FIELDS = [
    "package", "type", "failed_stage",
...
def write_fail(args):
    ...
    row = {
        ...
        "missing_header": summary.get("missing_header", ""),
        "missing_package": summary.get("missing_package", ""),
        "missing_library": summary.get("missing_library", ""),
        "missing_command": summary.get("missing_command", ""),
